...
public class Constants {
    ...
    public static class Drivetrain {
        ...
        SparkMaxFactory.Configuration leftMasterConfig = new SparkMaxFactory.Configuration(
                leftMasterPin, maxCurrent, stallCurrent, false, IdleMode.kBrake, true, 12.0);
        
        SparkMaxFactory.Configuration rightMasterMasterConfig = new SparkMaxFactory.Configuration(
                rightMasterPin, maxCurrent, stallCurrent, true, IdleMode.kBrake, true, 12.0);

        SparkMaxFactory.Configuration leftSlaveConfig =
